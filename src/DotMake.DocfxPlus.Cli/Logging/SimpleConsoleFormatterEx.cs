...
namespace DotMake.DocfxPlus.Cli.Logging
{
    internal sealed class SimpleConsoleFormatterEx : ConsoleFormatter, IDisposable
    {
        ...
        public SimpleConsoleFormatterEx(IOptionsMonitor<SimpleConsoleFormatterOptions> options)
        ...
        public override void Write<TState>(in LogEntry<TState> logEntry, IExternalScopeProvider? scopeProvider, TextWriter textWriter)
        {
            ...
            {
                textWriter.Write(AnsiParser.GetBackgroundColorEscapeCode(logLevelColors.Background.Value));
            }
            if (logLevelColors.Foreground.HasValue)
            {
                textWriter.Write(AnsiParser.GetForegroundColorEscapeCode(logLevelColors.Foreground.Value));
            }
