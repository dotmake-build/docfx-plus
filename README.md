...
jobs:
  publish-docs:
    ...
    # Install latest version of docfx-plus
...
```js
{
      ...
      "src": [
        {
          "src": "../src",
          "files": [
            "DotMake.CommandLine/DotMake.CommandLine.csproj"
          ]
        }
      ],
      "dest": "api", 
      "codeSourceBasePath": "../src/DotMake.CommandLine/", 
      "memberLayout": "separatePages",
      "categoryLayout": "nested"
    }
  ],
  "build": {
    "content": [
      ...
      {
        //Handle separately because we use different dest
        "files": ["*.md"],
        "src": "apidocs",
        "dest": "api"
      }
    ...
    "globalMetadata": {
      ...
      "_appLogoPath": "images/logo-wide.svg",
      //"_appLogoUrl": "./",
